            ...
            return (
                <div className="MatchDetails">
                    ...
                    </div>
                    {
                        ...
                        :
                            <div className="teams">
                                <div id='home' className={info.bet_for_local === '1' ? 'col col-1 button text-center disabled active' : 'col col-1 disabled button text-center'}></div>
                                <div id='tie' className={info.bet_for_draw === '1' ? 'col col-1 button text-center disabled active' : 'col col-1 disabled button text-center'}></div>
                                <div id='away' className={info.bet_for_away === '1' ? 'col col-1 button text-center disabled active' : 'col col-1 disabled button text-center'}></div>
                            </div>
                    }
                    {
                        info.status === 'played' ?
